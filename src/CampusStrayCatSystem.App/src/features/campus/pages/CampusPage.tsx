...
export function CampusPage() {
  ...
  return (
    <section className="feature-page campus-page">
      <PageHeader kicker="CAMPUS TRACK" title="校园地图与目击" icon="icon-map" description="从区域和点位开始，记录每一次与校园小邻居的相遇。" actions={<Button type="primary" onClick={openModal}><Icon name="icon-camera" size={16} />记录目击</Button>} />
